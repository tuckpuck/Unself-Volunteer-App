...
exports.seed = function(knex, Promise) {
  ...
  .then(function () {
    ...
    return knex('organizations').insert([
      {id: 1, name: 'Wilderness on Wheels', phone: '(303) 403-1110', email: 'wildernessonwheels@gmail.com', web_url: 'http://www.wildernessonwheels.org/', description: 'Providing ACCESS TO NATURE for people of all abilities, their family and caregivers for over 30 years. Our 1-mile boardwalk rises to 9,000 ft and allows everyone - young and old, diasabled and abled, individuals and groups - to roll and stroll through the beautiful Colorado mountains. Spend a day with friends and family fishing and grilling and then stay the night in a cabin or campsite.', photo_url: 'img/wildernessOnWheels.png'},
