  ...
  return knex('events').del()
    .then(function () {
      ...
      return knex('events').insert([
        {id: 1, name: 'Weekend Nature Walk', street_address: '4595 Highway 285', city_id: null, zip_code: '80448', start_date: '07-22-2017', end_date: '07-23-2017', start_time: '9:00AM', end_time: '5:00PM', description: 'Join us on our 1-mile boardwalk that allows everyone - young and old, diasabled and abled, individuals and groups - to roll and stroll through the beautiful Colorado mountains.', event_url: 'http://www.wildernessonwheels.org/', photo_url: 'http://www.goodnewsnetwork.org/wp-content/uploads/2014/10/wheelchair-accessible-forest-christine-Saetre-CC-640px.jpg', organization_id: 1},
